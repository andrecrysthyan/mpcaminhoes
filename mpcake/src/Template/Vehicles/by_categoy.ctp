<div class="container">
	<div class="col-md-12 retira-padding mostra-veiculos mostra-veiculos-categoria">
		<div class="row">
			 <?php $x = 0;?>
			<?php foreach($vehicles as $vehicle):?>
						...
						?>
						 <?php if($x!=0 && $x%3==0){
				          ...
				          ?>
						<a href="<?=$this->Url->build(['controller'=>'Vehicles','action'=>'view',$vehicle->id])?>"><div class="col-md-4 bloco-veiculo" data-aos="zoom-in">
