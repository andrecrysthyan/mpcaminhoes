...
<div class="col-md-12 retira-padding itens-footer">
	...
	<div class="col-md-3 noticias-transporte">
		...
		<p><figure><?php 
	 				echo $this->Html->image('noticia1.jpg', ['title' => 'Economizar gasolina', 'class' => 'col-md-6 retira-padding'])
					?></figure>
			<figcaption><span class="col-md-6 retira-padding">4 PASSOS PARA ECONOMIZAR COMBUSTÍVEL</span>
				<p class="col-md-12 retira-padding">Nas transportadoras, o combustível ainda representa uma fatia grande nos custos gerais do negócio.</p></figcaption></p>
