...
class NewsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'title' => ['type' => 'string', 'length' => 180, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2018-06-06 00:33:35',
                'modified' => '2018-06-06 00:33:35'
            ],
        ];
        parent::init();
    }
